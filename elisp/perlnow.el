...
;; TODO This is now astoundingly similar to "guess-module-run-string"
;; Really they should just be the same routines, no?
;; I think "script" has just one little additon, and it wouldn't
;; hurt to have it in "module" too.
