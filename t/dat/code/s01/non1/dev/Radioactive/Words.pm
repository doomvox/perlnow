...
Radioactive::Words - TODO Perl extension for blah blah blah

=head1 SYNOPSIS

   use Radioactive::Words ':all';

   TODO

=head1 DESCRIPTION

TODO  Stub documentation for Radioactive::Words,
...
BEGIN {
 ...
 qw(
  ...
  # The above allows declaration	use Radioactive::Words ':all';
