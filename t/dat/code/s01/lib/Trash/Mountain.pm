...
Trash::Mountain - TODO Perl extension for blah blah blah

=head1 SYNOPSIS

   use Trash::Mountain ':all';

   TODO

=head1 DESCRIPTION

TODO  Stub documentation for Trash::Mountain,
...
BEGIN {
 ...
 qw(
  ...
  # The above allows declaration	use Trash::Mountain ':all';
